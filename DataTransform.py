...
spark.sparkContext.addPyFile("s3://shooriyaprabhaa17-landingbucket-batch01/delta-core_2.12-1.2.0.jar")

# Define the configuration file path
config_file_path = "s3://shooriyaprabhaa17-rawbucket-batch01/app.json"
...
print(filename)
deltatablepath="s3://shooriyaprabhaa17-stagingbucket-batch01/deltatable/"
